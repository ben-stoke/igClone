!(function ($) {
  "use strict";
  function sideNav() {
    $(document).on("click", ".side-nav .side-nav-menu li a", function (e) {
  ...
  function sidePanelToggle() {
    $(document).on("click",".side-panel-toggle", function (e) {
  ...
  function todoToggle() {
    $(document).on("click",".todo-toggle", function (e) {
  ...
  function themeColorConfig() {
    $(".header-default input").change(function () {
      $(".app").removeClass(
        "header-primary header-info header-success header-danger header-dark"
      );
    }),
      $(".header-info input").change(function () {
        $(".app").addClass("header-info"),
          $(".app").removeClass(
            "header-primary header-success header-danger header-dark"
          );
      }),
      $(".header-primary input").change(function () {
        $(".app").addClass("header-primary"),
          $(".app").removeClass(
            "header-info header-success header-danger header-dark"
          );
      }),
      $(".header-success input").change(function () {
        $(".app").addClass("header-success"),
          $(".app").removeClass(
            "header-info header-primary header-danger header-dark"
          );
      }),
      $(".header-danger input").change(function () {
        $(".app").addClass("header-danger"),
          $(".app").removeClass(
            "header-info header-primary header-success header-dark"
          );
      }),
      $(".header-dark input").change(function () {
        $(".app").addClass("header-dark"),
          $(".app").removeClass(
            "header-info header-primary header-success header-danger"
          );
      }),
